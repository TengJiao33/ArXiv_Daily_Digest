...
window.RADAR_STATIC_DATA = {
  "generated_at": "2026-06-02 08:28:06",
  "summary": {
    ...
    "trend": [
      ...
      },
      {
        ...
        "total": 172,
        "directions": {
          "knowledge-editing-core": 46,
          "model-unlearning": 46,
          "editing-reliability-evaluation": 40,
          "editing-frameworks-tooling": 40
        }
      }
    ],
    "themes": [
    ...
    "limitations": [
      [
        "当前模型编辑依赖捷径而非真实语义，基础脆弱，该核心问题尚未得到有效解决",
        2
      ],
      [
      ...
      [
        "现有基于参数的知识编辑多忽略基础理论局限，极少在贴近实际场景下评估。",
        1
      ],
      [
    ...
    "failure_modes": [
      [
        "顺序编辑过程累积误差，导致编辑准确率和模型泛化能力逐渐下降",
        2
      ],
      [
        "现有模型编辑依赖隐藏捷径而非真实语义，在负例否定查询下完全失效",
        2
      ],
      [
        "编辑引发超出目标范围的模型扰动，原有方法通用知识保留能力下降。",
        2
      ],
      [
        "顺序深度优先编辑导致的编辑间串扰，微调用于模型编辑效果不佳",
        2
      ],
      [
        "现有知识编辑方法无法适配大规模音频语言模型的跨模态知识存储结构",
        2
      ],
      [
        "现有隐私防护方法泛化性差，无法处理未见过的隐私查询，还会导致模型原性能下降",
        2
      ],
      [
        "遗忘结构化关系知识时存在推理泄漏、灾难性遗忘",
        2
      ],
      [
    ...
    "evaluation_signals": [
      [
        "在数千次顺序编辑场景下，评测编辑成功率与模型通用能力的保留效果，验证方法优越性",
        2
      ],
      [
        "关注模型编辑在否定查询等负例输入下的鲁棒性，指出现有评估缺乏负例设计的缺陷",
        2
      ],
      [
        "在LLaMA3、GPT-J、Qwen2.5三个模型上评测编辑性能、知识保留能力与扰动程度。",
        2
      ],
      [
        "在多种大语言模型上验证编辑效果与通用能力保留情况，测试了超大规模编辑场景的性能",
        2
      ],
      [
        "构建了首个面向大规模音频语言模型知识编辑的音频基准，验证了音频编辑相比基线的效果优势。",
        2
      ],
      [
        "验证了方法对未见过敏感查询的泛化防护能力，以及原任务性能保留，证实了隐私防护与效用的平衡。",
        2
      ],
      [
        "GONE基准可拆解遗忘的三类效应，NEDS在两个7B级大模型上取得优异的遗忘效果与局部性，已开源代码。",
        2
      ],
      [
    ...
    "code_papers": [
      ...
      },
      {
        ...
        "url": "http://arxiv.org/abs/2509.24502",
        "repo_url": "https://github.com/holi-lab/SUIT.",
        "repo_stars": 1,
        "direction_name": "知识编辑核心方法"
      },
      {
      ...
      },
      {
        ...
        "url": "http://arxiv.org/abs/2508.03741",
        "repo_url": "https://github.com/Linuxin-xxx/LKS.",
        "repo_stars": 0,
        "direction_name": "编辑框架、工具与基准"
      },
      {
        "title": "A Survey of LLM-Driven AI Agent Communication: Protocols, Security Risks, and Defense Countermeasures",
        "url": "http://arxiv.org/abs/2506.19676",
        "repo_url": "https://github.com/theshi-1128/awesome-agent-communication-security.",
        "repo_stars": 26,
        "direction_name": "编辑框架、工具与基准"
      },
      {
        "title": "On the Adaptive Psychological Persuasion of Large Language Models",
        "url": "http://arxiv.org/abs/2506.06800",
        "repo_url": "https://github.com/KalinaEine/PsychologicalPersuasion.",
        "repo_stars": 6,
        "direction_name": "编辑框架、工具与基准"
      }
    ]
  ...
  "papers": [
    ...
    },
    {
      ...
      "title_zh": "通过感知压力的联合邻域优化重访知识编辑中的涟漪效应",
      "authors": [
        "Haoben Huang",
        "Shuxin Liu",
        "Ou Wu",
      ...
      "pdf_url": "https://arxiv.org/pdf/2606.01610v1",
      "category": "cs.AI",
      "published": "2026-06-01 03:00:13+00:00",
      ...
      "abstract_zh": "大语言模型单次编辑更新会在局部知识邻域引发涟漪效应：对相关事实的理想传播和对需保留事实的意外扰动。现有方法分开处理这两种效应，未显式建模二者耦合。本文分析典型基线的涟漪响应，识别出两种耦合设计压力，提出联合邻域优化JNO框架，在目标规划阶段联合处理两类压力，实验表明JNO在RippleEdits上使传播和保留指标至少提升7.0%，同时保持跨骨干编辑稳定性。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有知识编辑方法分开处理涟漪效应的理想传播和意外扰动，未建模二者的耦合关系",
      "method": "提出感知压力的联合邻域优化框架JNO，联合优化邻域目标表示，加入预执行门过滤高风险方案",
      "contribution": "识别出知识编辑涟漪效应的两种耦合设计压力，所提方法使指标提升7%以上，保持编辑稳定性",
      "limitations": "摘要未提及",
      "key_finding": "知识编辑涟漪效应存在可编辑侧协调、保留侧泄漏两种耦合设计压力，JNO使指标至少提升7.0%",
      "theme": "编辑涟漪效应",
      "method_family": "framework/tooling",
      "edit_target": "事实关联",
      "evaluation_signal": "在RippleEdits基准上评测知识编辑的传播性能、保留性能，以及跨骨干编辑的稳定性",
      "failure_mode": "单次知识编辑引发涟漪效应，意外扰动需保留的原有知识",
      "idea_hook": "可探索将耦合压力建模思路拓展到顺序多轮知识编辑，进一步提升多编辑场景的稳定性",
      "read_priority": "high",
      "direction_fit": "属于知识编辑核心问题研究，方法有创新性，对该方向研究具备较高参考价值",
      "baselines": [],
      "datasets": [
        "RippleEdits"
      ]
    },
    {
      ...
      "title_zh": "AnyEdit++：基于贝叶斯惊奇的自适应长格式知识编辑",
      "authors": [
        "Bowen Tian",
        "Caixue He",
        "Jiemin Wu",
      ...
      "url": "http://arxiv.org/abs/2606.01053v1",
      "pdf_url": "https://arxiv.org/pdf/2606.01053v1",
      "category": "cs.AI",
      "published": "2026-05-31 06:48:43+00:00",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "大语言模型中复杂长格式知识编辑因难以维持生成连贯性仍是一大挑战。现有AnyEdit等自回归方法缓解了长度约束，但依赖固定窗口分块，忽略逻辑结构会损害一致性。本文提出结构感知框架AnyEdit++，引入基于贝叶斯惊奇动态识别语义边界的自适应分割机制Bayes-Chunk，建立包含两大核心原则的理论框架，多类任务实验验证其性能优于现有SOTA，证明结构感知的重要性。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "manual",
      "venue_source": "override",
      "problem": "大语言模型复杂长格式知识编辑难以保持生成连贯，现有固定分块忽略逻辑结构，损害一致性。",
      "method": "提出结构感知框架AnyEdit++，设计基于贝叶斯惊奇识别语义边界的自适应分块机制Bayes-Chunk。",
      "contribution": "提出两大核心理论原则，多任务性能优于SOTA，验证结构感知对长知识编辑的关键作用。",
      "limitations": "摘要未提及",
      "key_finding": "基于贝叶斯惊奇得到的语义边界天然满足锚键几何正交，在此处更新比任意分裂点控制效果更优。",
      "theme": "长格式知识编辑",
      "method_family": "framework/tooling",
      "edit_target": "长格式知识",
      "evaluation_signal": "在数学推理、代码生成、叙事三类任务上，验证了AnyEdit++的性能与鲁棒性优于现有前沿基线。",
      "failure_mode": "固定窗口分块忽略逻辑结构，导致跨段编辑干扰大，损害编辑一致性",
      "idea_hook": "可探索将贝叶斯惊奇自适应分块推广到开放域大规模长文档知识编辑，验证其泛化能力。",
      "read_priority": "high",
      "direction_fit": "本文聚焦知识编辑领域的长格式知识编辑核心问题，方法有创新，与方向高度契合。",
      "baselines": [
        "AnyEdit",
        "现有SOTA知识编辑基线"
      ],
    ...
    },
    {
      ...
      "url": "http://arxiv.org/abs/2606.00570v1",
      "pdf_url": "https://arxiv.org/pdf/2606.00570v1",
      "category": "cs.CL",
      "published": "2026-05-30 06:44:40+00:00",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "基于参数的知识编辑通过局部修改权重更新大语言模型内部知识，受到广泛关注，但现有方法大多忽略基础理论局限，极少在贴近实际的场景中评估。本文基于维度坍塌假说开展理论分析，解释局部编辑引发全局干扰最终导致推理崩溃的机制，随后开展全面实证评估，发现参数编辑方法会持续损伤大模型核心能力，简单的基于检索基线性能优于所有参数编辑方法，指出未来研究需核心关注编辑后模型能力的保留。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "manual",
      "venue_source": "override",
      "problem": "现有基于参数的大语言模型知识编辑忽略基础理论局限，极少在贴近实际的场景中评估。",
      "method": "基于维度坍塌假说开展理论分析，系统变换变量对现有方法开展全面实证评估。",
      "contribution": "揭示参数编辑引发推理崩溃的机制，实证证明参数编辑会损伤大模型核心能力。",
      "limitations": "现有基于参数的知识编辑多忽略基础理论局限，极少在贴近实际场景下评估。",
      "key_finding": "局部参数编辑会引发全局干扰导致推理崩溃，参数编辑持续损伤大模型核心能力，基于检索基线性能全面更优。",
      "theme": "知识编辑评估",
      "method_family": "evaluation/benchmark",
      "edit_target": "模型内部知识",
      "evaluation_signal": "评估不同知识复杂度、编辑数量下各方法性能，重点考察知识编辑后大模型核心能力的保留情况。",
      "failure_mode": "局部参数编辑引发全局干扰，导致推理崩溃，损伤大模型原有核心能力",
      "idea_hook": "如何改进基于参数的知识编辑，缓解编辑带来的全局干扰与大模型核心能力损伤？",
      "read_priority": "high",
      "direction_fit": "属于知识编辑方向的理论与实证研究，对该方向后续研究有重要参考价值。",
      "baselines": [
        "基于检索的基线方法",
        "现有基于参数的知识编辑方法"
      ],
    ...
    },
    {
      ...
      "title_zh": "少编辑多收益：面向大语言模型终身知识编辑的动态稀疏神经元掩码",
      "authors": [
        "Jinzhe Liu",
        "Junshu Sun",
        "Shufan Shen",
      ...
      "abstract_zh": "终身知识编辑可在无需计算成本高昂的全量重训练前提下，对大语言模型中的过时知识进行持续精准更新。现有方法往往在编辑过程中不断累积误差，导致编辑准确率与泛化能力逐渐下降。针对该问题，本文提出神经元特异性掩码知识编辑框架NMKE，结合神经元级归因与动态稀疏掩码，区分两类知识神经元，通过熵引导动态掩码定位目标相关神经元，仅修改更少参数即可实现精准编辑。数千次顺序编辑实验证明，NMKE性能优于现有方法。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有终身知识编辑方法在编辑过程累积误差，导致编辑准确率和模型泛化能力逐渐下降",
      "method": "提出NMKE框架，结合神经元归因与熵引导动态稀疏掩码，定位目标知识相关神经元实现精准编辑",
      "contribution": "提出细粒度知识编辑框架NMKE，数千次顺序编辑实验证明其性能优于现有同类方法",
      "limitations": "摘要未提及",
      "key_finding": "熵引导动态稀疏掩码定位相关神经元，仅修改更少参数，在数千次顺序编辑中性能优于现有方法",
      "theme": "终身知识编辑",
      "method_family": "locate-then-edit",
      "edit_target": "事实知识",
      "evaluation_signal": "在数千次顺序编辑场景下，评测编辑成功率与模型通用能力的保留效果，验证方法优越性",
      "failure_mode": "顺序编辑过程累积误差，导致编辑准确率和模型泛化能力逐渐下降",
      "idea_hook": "可探究该动态稀疏掩码机制在更大规模、多领域终身知识编辑场景下的适配性与扩展能力",
      "read_priority": "high",
      "direction_fit": "本文聚焦大模型终身知识编辑核心问题，方法有创新，完全契合知识编辑研究方向",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "week": "2026-W23",
      "title": "MedREK: Retrieval-Based Editing for Medical LLMs with Key-Aware Prompts",
      "title_zh": "MedREK：基于键感知提示的医疗大语言模型检索式编辑",
      "authors": [
        "Shujun Xia",
        "Haokun Lin",
        "Yichen Wu",
      ...
      "abstract_zh": "大语言模型在医疗领域应用前景广阔，但医疗知识快速迭代、训练数据存在错误，常导致模型生成过时或不准确信息，限制其在高风险临床场景应用。模型编辑无需全量重训练是潜在方案，但基于参数的编辑易破坏局部性，不适用于医疗领域，检索式编辑更可行，却仍存两大挑战：医疗知识空间表示重叠导致检索不准、编辑精度低，且现有方法仅支持单样本编辑，批量编辑尚未探索。本文构建了覆盖更广医疗领域的增强基准MedVersa，提出检索式编辑框架MedREK，实验验证其性能优异，是首个经验证的医疗大模型批量编辑方案。",
      "has_code": true,
      "repo_url": "https://github.com/mylittleriver/MedREK.",
      "repo_stars": 5,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有医疗大语言模型检索式编辑检索精度不足，且缺乏支持批量编辑的有效方案",
      "method": "提出整合共享查询-键精准匹配模块与注意力提示编码器的检索式编辑框架MedREK",
      "contribution": "构建医疗编辑基准MedVersa，所提MedREK性能优异，是首个经验证的医疗大模型批量编辑方案",
      "limitations": "摘要未提及",
      "key_finding": "整合键感知匹配的检索式编辑在医疗知识编辑上性能优于现有方案，首个验证了医疗大模型批量编辑的可行性",
      "theme": "医疗知识编辑",
      "method_family": "memory-based editor",
      "edit_target": "医疗事实知识",
      "evaluation_signal": "在严格局部性约束下评测单样本与批量编辑性能，验证所提方法在多个医疗基准上核心指标更优异",
      "failure_mode": "参数编辑破坏局部性，检索编辑因表示重叠导致检索不准，现有方法不支持批量编辑",
      "idea_hook": "可探索将键感知检索编辑框架推广到其他专业领域，解决专业化领域的批量知识编辑需求",
      "read_priority": "high",
      "direction_fit": "属于知识编辑方向在医疗领域的应用，提出新方法与新基准，对该方向研究有较高参考价值",
      "baselines": [
        "摘要未提及具体基线"
      ],
      "datasets": [
    ...
    },
    {
      ...
      "title_zh": "ACE：面向多跳事实召回的归因控制知识编辑",
      "authors": [
        "Jiayu Yang",
        "Yuxuan Fan",
        "Songning Lai",
      ...
      "abstract_zh": "大语言模型需要高效知识编辑更新事实信息，但现有方法在多跳事实召回中存在显著性能衰减，编辑推理链中的隐式中间主体时问题尤为严重。本文通过因果分析揭示该缺陷源于忽略链式知识在神经元层面的动态表示与利用，发现多跳推理中隐式主体作为查询神经元，逐层激活对应值神经元累积信息得到最终答案，进而提出基于神经元归因定位编辑关键查询值通路的ACE框架，在GPT-J上性能超SOTA 9.44%，在Qwen3-8B上超37.46%。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "manual",
      "venue_source": "override",
      "problem": "现有知识编辑方法在多跳事实召回中性能衰减显著，编辑推理链隐式中间主体时问题尤为突出。",
      "method": "提出ACE框架，依托神经元层面归因定位并编辑推理过程中关键的查询-值通路。",
      "contribution": "揭示多跳推理神经元动态机制，所提方法性能显著优于SOTA，开辟知识编辑新路径。",
      "limitations": "摘要未提及",
      "key_finding": "多跳推理中隐式主体作为查询神经元逐层激活值神经元累积信息，ACE在GPT-J超SOTA 9.44%、Qwen3-8B超SOTA 37.46%",
      "theme": "多跳知识编辑",
      "method_family": "locate-then-edit",
      "edit_target": "事实关联",
      "evaluation_signal": "评测多跳事实召回性能，所提ACE比现有SOTA在GPT-J高9.44%，在Qwen3-8B高37.46%",
      "failure_mode": "多跳知识编辑后事实召回性能显著衰减，编辑含隐式中间主体的知识时尤甚",
      "idea_hook": "可基于神经元通路归因机制，进一步探索复杂推理场景下大模型的高效知识编辑方案",
      "read_priority": "high",
      "direction_fit": "属于知识编辑核心研究方向，针对多跳编辑痛点提出新机制方法，创新性较强",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "title_zh": "模型编辑建立在流沙之上吗？揭示其虚幻成功与脆弱基础",
      "authors": [
        "Wei Liu",
        "Hao Xu",
        "Bingqing Liu",
      ...
      "abstract_zh": "大语言模型不可避免会编码过时或错误知识，模型编辑通过微调少量参数更新特定知识同时保留其余知识，被认为颇具前景。本文指出现有模型编辑的可靠性建立在脆弱基础上，成果多为虚幻成功，模型利用隐藏捷径而非真实语义，该问题被缺乏负例设计的评估框架长期掩盖。本文开发了一套新评估方法，发现现有SOTA方法在最简单否定查询下就会失效，呼吁重新思考模型编辑基础。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "当前模型编辑领域成果可靠性存疑，现有评估框架缺少负例设计，存在根本性缺陷",
      "method": "系统开发了一套引入负例设计的全新评估方案，测试现有主流模型编辑方法的可靠性",
      "contribution": "揭示现有模型编辑实际依赖隐藏捷径而非真实语义，发现SOTA方法在简单否定查询下完全失效",
      "limitations": "当前模型编辑依赖捷径而非真实语义，基础脆弱，该核心问题尚未得到有效解决",
      "key_finding": "现有最优模型编辑方法依赖隐藏捷径而非真实语义，在最简单的否定查询下就会完全失效",
      "theme": "模型编辑评估",
      "method_family": "evaluation/benchmark",
      "edit_target": "事实关联知识",
      "evaluation_signal": "关注模型编辑在否定查询等负例输入下的鲁棒性，指出现有评估缺乏负例设计的缺陷",
      "failure_mode": "现有模型编辑依赖隐藏捷径而非真实语义，在负例否定查询下完全失效",
      "idea_hook": "可探索规避捷径依赖、基于真实语义的鲁棒模型编辑，重构科学的模型编辑评估体系",
      "read_priority": "high",
      "direction_fit": "本文属于知识编辑可靠性研究，直击领域核心问题，对该方向研究有重要参考价值",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "week": "2026-W23",
      "title": "KnowledgeSmith: Uncovering Knowledge Updating in LLMs with Model Editing and Unlearning",
      "title_zh": "KnowledgeSmith：基于模型编辑与遗忘挖掘大语言模型知识更新机制",
      "authors": [
        "Yinyi Luo",
        "Zhexian Zhou",
        "Hao Chen",
      ...
      "abstract_zh": "知识编辑与机器遗忘是实现大语言模型知识更新的两类主流方法，但由于现有评估存在不足、孤立、规模小的问题，大语言模型的知识更新机制仍未得到充分探索。本文提出统一框架KnowledgeSmith，将知识编辑与遗忘统一建模为约束优化问题，开发了自动数据集生成器，可开展知识更新策略的可控研究，实验得到了多项细粒度洞见，可为相关策略设计提供参考。",
      "has_code": true,
      "repo_url": "https://github.com/AIFrontierLab/KnowledgeSmith.git",
      "repo_stars": 9,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "manual",
      "venue_source": "override",
      "problem": "现有知识更新评估存在不足、孤立、规模小的问题，大语言模型知识更新机制尚未得到充分探索。",
      "method": "提出统一框架KnowledgeSmith，将编辑与遗忘统一为约束优化问题，开发自动数据集生成器开展可控研究。",
      "contribution": "提出统一分析框架与自动数据集生成器，得到多项知识更新的细粒度洞见，为策略设计提供参考。",
      "limitations": "摘要未提及",
      "key_finding": "大语言模型不同层级知识的更新过程与人类并不相似，知识更新过程中存在一致性-容量权衡。",
      "theme": "知识更新机制",
      "method_family": "framework/tooling",
      "edit_target": "事实关联知识",
      "evaluation_signal": "评测知识更新中的知识传播、可塑性缩放、一致性与鲁棒性，重点揭示了一致性-容量的权衡关系。",
      "failure_mode": "现有知识更新评估不足、孤立且规模小，难以支撑知识更新机制的探究。",
      "idea_hook": "可基于该统一框架进一步探索不同大模型的知识更新特性，优化一致性-容量权衡下的编辑策略。",
      "read_priority": "high",
      "direction_fit": "该论文聚焦知识编辑与遗忘场景下的知识更新机制，属于本方向核心研究问题，参考价值高。",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "abstract_zh": "大语言模型需要持续更新以匹配不断演化的真实世界知识，模型编辑是比重训更轻量的方案，但顺序编辑常引发表征不稳定与灾难性遗忘。本文假设超球面均匀性可帮助模型维持稳定，兼顾旧知识保留与新知识容纳，用超球面能量(HE)量化神经元均匀性，发现HE波动与编辑性能强相关，还从理论证明HE动力学对预训练知识退化存在下界。据此提出SPHERE正则策略，实验显示比最优基线编辑性能平均提升16.41%。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "manual",
      "venue_source": "override",
      "problem": "针对大语言模型顺序编辑过程中表征不稳定、引发灾难性遗忘与性能退化的问题",
      "method": "提出超球面能量正则化的SPHERE方法，将新知识投影到稀疏互补空间以减少原有权重扰动",
      "contribution": "从实证和理论层面揭示超球面能量动力学与编辑性能的关联，提出的方法优于现有基线",
      "limitations": "摘要未提及",
      "key_finding": "超球面能量动力学与编辑性能强相关，编辑失败始终伴随高HE波动，方法比最优基线性能平均提升16.41%",
      "theme": "顺序模型编辑",
      "method_family": "正则化编辑",
      "edit_target": "模型参数",
      "evaluation_signal": "评测所提方法的编辑能力，以及对预训练模型原有通用性能的保留效果，验证方法有效性",
      "failure_mode": "顺序编辑不稳定、灾难性遗忘",
      "idea_hook": "可将超球面能量正则化思路扩展到大模型批量知识编辑场景，进一步提升大规模编辑的稳定性",
      "read_priority": "high",
      "direction_fit": "本文研究大模型顺序知识编辑的可靠性问题，高度贴合知识编辑领域的研究方向",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "url": "http://arxiv.org/abs/2509.24502",
      "pdf_url": "http://arxiv.org/pdf/2509.24502",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "知识编辑旨在高效修正语言模型中的事实错误，现有定位后编辑方法无约束获取键值向量，易引发超出目标编辑的显著模型扰动。本文提出子空间知识编辑SUIT，仅在编辑相关的关键特征子空间计算键值向量，在多个主流模型上的实验表明，该方法在保持高编辑性能的同时大幅提升知识保留能力，证实编辑关键子空间识别是可靠低扰动知识编辑的核心原则，代码已开源。",
      "has_code": true,
      "repo_url": "https://github.com/holi-lab/SUIT.",
      "repo_stars": 1,
      "hf_upvotes": 0,
      ...
      "venue_year": 2026,
      "venue_type": "poster",
      "venue_url": "https://openreview.net/forum?id=qz3BkyyHWJ",
      "venue_confidence": "manual",
      "venue_source": "override",
      "problem": "现有定位后知识编辑方法无约束获取键值，易引发超出目标的模型扰动，知识保留效果差。",
      "method": "提出子空间知识编辑方法SUIT，仅在编辑相关的关键特征子空间内计算键值向量。",
      "contribution": "提出SUIT方法，验证了编辑关键子空间识别是可靠低扰动知识编辑的核心原则。",
      "limitations": "摘要未提及",
      "key_finding": "将键值计算限制在编辑关键子空间，可大幅降低隐状态非预期扰动，兼顾编辑性能与知识保留。",
      "theme": "低扰动知识编辑",
      "method_family": "locate-then-edit",
      "edit_target": "事实关联",
      "evaluation_signal": "在LLaMA3、GPT-J、Qwen2.5三个模型上评测编辑性能、知识保留能力与扰动程度。",
      "failure_mode": "编辑引发超出目标范围的模型扰动，原有方法通用知识保留能力下降。",
      "idea_hook": "可探索面向多轮顺序知识编辑的动态关键子空间识别，提升顺序编辑的稳定性。",
      "read_priority": "high",
      "direction_fit": "属于知识编辑核心方向，聚焦低扰动编辑痛点，方法有新意且开源，研究价值高。",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "abstract_zh": "学界长期认为微调无法有效用于模型编辑，本文指出该失效并非微调固有缺陷，而是现有顺序编辑的深度优先单遍流水线过度优化单条编辑，引发编辑间干扰。本文将微调恢复为标准基于轮次的广度优先小批量流水线，大幅提升效果，进一步分析调优位置后提出局部编辑方法LocFT-BF。实验显示该方法大幅优于现有最优方法，首次可支持10万次编辑、720亿参数模型且不损失通用能力，纠正了长期误解。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "manual",
      "venue_source": "override",
      "problem": "学界长期认为微调无法有效用于模型编辑，现有适配顺序编辑任务的微调效果不佳",
      "method": "采用基于轮次的广度优先小批量微调流水线，分析调优位置后提出局部编辑方法LocFT-BF",
      "contribution": "纠正了关于微调的长期误解，提出的方法性能优于SOTA，可支持大规模大模型编辑",
      "limitations": "摘要未提及",
      "key_finding": "基于轮次的广度优先流水线即可大幅提升微调编辑效果，LocFT-BF可支持10万次编辑、72B参数模型且不损失通用能力",
      "theme": "模型编辑方法",
      "method_family": "locate-then-edit",
      "edit_target": "事实关联",
      "evaluation_signal": "在多种大语言模型上验证编辑效果与通用能力保留情况，测试了超大规模编辑场景的性能",
      "failure_mode": "顺序深度优先编辑导致的编辑间串扰，微调用于模型编辑效果不佳",
      "idea_hook": "可基于该局部微调框架探索更大规模模型编辑场景，进一步提升编辑效率与通用能力保留",
      "read_priority": "high",
      "direction_fit": "本文属于知识编辑研究方向，提出了效果领先的新方法，对领域研究有较高参考价值",
      "baselines": [
        "传统深度优先流水线微调",
        "现有最优模型编辑方法"
      ],
    ...
    },
    {
      ...
      "title_zh": "模型编辑是一把双刃剑：引导智能体伦理行为走向善或恶",
      "authors": [
        "Baixiang Huang",
        "Zhen Tan",
        "Haoran Wang",
      ...
      "abstract_zh": "基于大语言模型的智能体已具备出色的任务能力，但在高风险领域部署存在严重安全伦理风险，不道德行为会引发严重现实后果。本文将智能体行为引导建模为行为编辑任务，提出基于心理学道德理论的多层基准BehaviorBench，验证表明行为编辑既可引导智能体走向良善，也可诱导出恶意有害行为，凸显该范式的机遇与风险。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "大语言模型智能体在高风险场景部署存在伦理安全风险，缺乏系统化的行为引导与评估方案",
      "method": "将智能体行为引导建模为行为编辑任务，构建基于心理学道德理论的分层基准BehaviorBench",
      "contribution": "验证行为编辑可局部调整也可全局改变智能体道德对齐，兼具导善与引恶的能力，验证了方法有效性",
      "limitations": "摘要未提及",
      "key_finding": "行为编辑既可以做场景特定的局部行为调整，也能全局改变智能体道德对齐，既能导善也可诱导恶意行为",
      "theme": "伦理行为编辑",
      "method_family": "steering evaluation/benchmark",
      "edit_target": "智能体伦理行为",
      "evaluation_signal": "提出基于心理学道德理论的分层多场景基准BehaviorBench，可评估不同复杂度场景下行为编辑的效果",
      "failure_mode": "不当使用模型编辑可诱导智能体产生有害的不道德行为",
      "idea_hook": "如何设计有效安全约束，避免模型编辑被恶意利用，诱导大语言模型智能体产生有害行为？",
      "read_priority": "high",
      "direction_fit": "本文属于模型编辑方向，研究行为编辑的安全影响，提出新基准，对方向研究参考价值较高",
      "baselines": [],
      "datasets": [
        "BehaviorBench"
      ]
    },
    {
      ...
      "url": "http://arxiv.org/abs/2604.05876",
      "pdf_url": "http://arxiv.org/pdf/2604.05876",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "在现实动态环境部署大语言模型（LLM）面临更新预训练知识的挑战。现有知识编辑方法虽能可靠修补孤立事实，但普遍存在“推理缺口”：模型能回忆编辑后的事实，却无法在多步推理链中应用它。为填补该缺口，本文提出MCircKE框架，采用“定位-适配”的精确编辑流程，先识别特定推理任务的因果电路，再仅更新电路内参数，在MQuAKE-3K基准上验证了方法有效性。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有知识编辑方法修补孤立事实后，存在模型无法在多步推理中利用编辑知识的推理缺口问题",
      "method": "提出MCircKE框架，先定位目标推理任务对应的因果电路，仅对该电路内参数做精准更新",
      "contribution": "提出基于机制电路的知识编辑框架，在MQuAKE-3K基准验证了其多跳推理编辑的有效性",
      "limitations": "摘要未提及",
      "key_finding": "定位特定推理任务的因果电路后仅更新电路内参数，可有效解决知识编辑后的多步推理缺口",
      "theme": "知识编辑",
      "method_family": "locate-then-edit",
      "edit_target": "事实知识",
      "evaluation_signal": "在MQuAKE-3K基准评测所提方法，验证其在知识编辑场景下多跳推理任务的有效性",
      "failure_mode": "知识编辑后仅能回忆编辑事实，无法将其应用于多步推理过程",
      "idea_hook": "可拓展该基于因果电路的编辑思路到批量多事实编辑场景，验证其通用编辑性能",
      "read_priority": "high",
      "direction_fit": "属于知识编辑核心研究方向，针对现有方法缺陷提出新方案，具备较高参考价值",
      "baselines": [],
      "datasets": [
        "MQuAKE-3K"
      ]
    ...
    },
    {
      ...
      "collected": "2026-06-02",
      "abstract": "The dynamic nature of information necessitates continuously updating large vision-language models (LVLMs). While recent knowledge editing techniques hint at promising directions, they often focus on editing a single modality (vision or language) in isolation. This prevalent practice neglects the inherent multimodality of LVLMs and the continuous nature of knowledge updates, potentially leading to suboptimal editing outcomes when considering the interplay between modalities and the need for ongoing knowledge refinement. To address these limitations, we propose MemEIC, a novel method for Continual and Compositional Knowledge Editing (CCKE) in LVLMs. MemEIC enables compositional editing of both visual and textual knowledge sequentially. Our approach employs a hybrid external-internal editor featuring a dual external memory for cross-modal evidence retrieval and dual LoRA adapters that facilitate disentangled parameter updates for each modality. A key component is a brain-inspired knowledge connector, activated selectively for compositional reasoning, that integrates information across different modalities. Experiments demonstrate that MemEIC significantly improves performance on complex multimodal questions and effectively preserves prior edits, setting a new benchmark for CCKE in LVLMs.",
      "abstract_zh": "信息的动态特性要求持续更新大型视觉语言模型（LVLMs）。现有知识编辑技术通常仅单独编辑单一模态，忽略了LVLMs的多模态本质与知识更新的持续性，易得到次优编辑结果。为此本文提出面向LVLMs持续组合式知识编辑（CCKE）的新方法MemEIC，采用混合内外编辑器，结合双外部记忆检索跨模态证据、双LoRA适配器实现解耦参数更新，搭配脑启发知识连接器整合跨模态信息。实验表明MemEIC显著提升性能，有效保留先前编辑，建立了领域新基准。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有知识编辑多单独编辑单一模态，忽略多模态大模型的多模态性与更新持续性，编辑效果欠佳。",
      "method": "提出MemEIC方法，采用混合内外编辑器，结合双外部记忆、双LoRA适配器与知识连接器实现多模态持续组合编辑。",
      "contribution": "提出LVLM持续组合知识编辑新方法MemEIC，效果显著提升，建立了该任务的新基准。",
      "limitations": "摘要未提及",
      "key_finding": "搭配双外部记忆、双LoRA与脑启发连接器的混合架构，可同时提升编辑性能和先前编辑的保留能力。",
      "theme": "知识编辑",
      "method_family": "memory-based editor",
      "edit_target": "多模态知识关联",
      "evaluation_signal": "评测了复杂多模态问题回答性能与先前编辑保留效果，建立了LVLM持续组合知识编辑的新基准。",
      "failure_mode": "单模态独立编辑忽略多模态交互，导致持续编辑效果差，先前编辑容易丢失",
      "idea_hook": "可拓展该架构到通用多模态大模型，探索不同参数量下该多模态编辑方案的泛化能力。",
      "read_priority": "high",
      "direction_fit": "本文聚焦多模态大模型的持续组合知识编辑，是知识编辑领域前沿问题，高度贴合研究方向。",
      "baselines": [],
      "datasets": []
    },
    {
    ...
    },
    {
      ...
      "title_zh": "SAKE：面向大音频语言模型的听觉属性知识编辑",
      "authors": [
        "Chih-Kai Yang",
        "Yen-Ting Piao",
        "Tzu-Wen Hsu",
      ...
      "url": "http://arxiv.org/abs/2510.16917",
      "pdf_url": "http://arxiv.org/pdf/2510.16917",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "知识编辑可实现无需全量重训练的目标知识更新，但现有工作多聚焦文本或视觉事实，抽象听觉感知知识尚未得到充分探索。本文提出首个面向大音频语言模型听觉感知属性知识编辑的基准SAKE，在多维度评测不同场景下多种现有方法的表现，揭示现有方法局限，为听觉专用编辑技术奠定基础。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有知识编辑研究多聚焦文本、视觉事实，缺乏针对大音频语言模型听觉属性知识编辑的探索",
      "method": "构建首个大音频语言模型听觉属性知识编辑基准SAKE，从多维度评测多种现有编辑方法",
      "contribution": "提出首个听觉属性知识编辑基准SAKE，揭示现有编辑方法的核心局限，为后续研究提供基础",
      "limitations": "现有多数编辑方法难以实现听觉泛化，顺序编辑易出现遗忘与模型性能退化",
      "key_finding": "多数现有编辑可靠性尚可，但在听觉泛化等方面表现差，微调模态连接器比直接编辑LLM主干更鲁棒均衡",
      "theme": "音频知识编辑",
      "method_family": "evaluation/benchmark",
      "edit_target": "听觉属性知识",
      "evaluation_signal": "在单编辑和顺序编辑场景下，从可靠性、泛化性、局部性、可移植性四个维度评测八种编辑方法",
      "failure_mode": "顺序编辑遗忘退化，现有方法难以满足听觉泛化与局部性要求",
      "idea_hook": "可针对大音频语言模型的特性设计专用知识编辑方法，解决现有方法听觉泛化不足的问题",
      "read_priority": "high",
      "direction_fit": "属于知识编辑研究方向，拓展了知识编辑到音频多模态领域，具有较高研究价值",
      "baselines": [
        "微调模态连接器",
        "直接编辑大语言模型主干"
      ],
    ...
    },
    {
      ...
      "title_zh": "BlackIce：面向AI安全测试的容器化红队工具包",
      "authors": [
        "Caelin Kaplan",
        "A. Warnecke",
        "Neil D. Archibald"
      ],
      "url": "http://arxiv.org/abs/2510.11823",
      "pdf_url": "http://arxiv.org/pdf/2510.11823",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "AI模型日益广泛集成到实际系统中，其安全问题受到高度关注，AI红队成为组织主动发现漏洞的重要手段。但现有AI红队工具选型困难、软件依赖复杂冲突，且专业团队稀少，AI安全评估门槛高、缺乏标准化环境。受Kali Linux启发，本文推出开源容器化工具包BlackIce，面向大语言模型与传统ML模型提供红队测试，打包14个精选工具，统一接口，支持一键启动，模块化方便扩展，介绍了其架构、筛选流程和支持的评估。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有AI红队工具选型困难，软件依赖复杂冲突，专业团队少，AI安全评估门槛高，缺乏标准化环境",
      "method": "提出开源容器化AI红队工具包BlackIce，打包精选测试工具，提供统一命令行接口与模块化可扩展架构",
      "contribution": "推出可复现易部署的开源AI红队工具包，降低AI安全测试门槛，支持社区灵活扩展更新",
      "limitations": "摘要未提及",
      "key_finding": "打包14个精选开源负责任AI与安全测试工具，容器化镜像一键即可启动红队评估，模块化架构支持扩展",
      "theme": "AI安全测试",
      "method_family": "framework/tooling",
      "edit_target": "不涉及",
      "evaluation_signal": "提供可复现、易部署的开源AI红队工具，统一命令行接口，支持本地与云端灵活部署评估",
      "failure_mode": "现有AI红队工具依赖冲突复杂，部署难度大，入门门槛高，缺乏统一标准化评估环境",
      "idea_hook": "可基于该标准化工具批量评测知识编辑后模型的安全可靠性，分析知识编辑带来的安全副作用",
      "read_priority": "medium",
      "direction_fit": "属于AI安全可靠性领域，提供的标准化工具可用于评测知识编辑方案的安全特性",
      "baselines": [],
      "datasets": []
    },
    {
    ...
    },
    {
      ...
      "url": "http://arxiv.org/abs/2509.21993",
      "pdf_url": "http://arxiv.org/pdf/2509.21993",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "反转诅咒被广泛认为是语言模型的根本局限，即模型无法从已习得的“A是B”推导出未见事实“B是A”。本文指出这并非固有缺陷，而是知识编码方式带来的问题。研究发现，在合成关系知识图上从头训练可诱导模型隐藏表征涌现双线性关系结构，该结构可缓解反转诅咒，支持模型编辑保持逻辑一致。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "针对语言模型存在的反转诅咒问题，以及现有模型编辑易产生逻辑不一致的缺陷",
      "method": "通过在合成关系知识图上从头训练模型，诱导内部隐藏表征涌现出双线性关系结构",
      "contribution": "证明反转诅咒并非语言模型固有缺陷，证实双线性表征可支持编辑后保持逻辑一致性",
      "limitations": "摘要未提及",
      "key_finding": "在关系知识数据集上训练可诱导模型涌现双线性内部表征，单事实更新可正确传播到反向与逻辑依赖关系",
      "theme": "模型编辑一致性",
      "method_family": "steering",
      "edit_target": "事实关联",
      "evaluation_signal": "验证双线性表征对反转诅咒的缓解效果，以及模型编辑后的逻辑一致性",
      "failure_mode": "反转诅咒，模型编辑无法泛化到反向及逻辑依赖事实，导致逻辑不一致",
      "idea_hook": "可探究如何在预训练大模型中引入双线性知识结构，提升现有模型编辑方法的一致性",
      "read_priority": "high",
      "direction_fit": "本文聚焦知识编辑的一致性问题，从表征角度揭示核心机制，对方向研究有较高启发",
      "baselines": [],
      "datasets": [
        "合成关系知识图"
      ]
    },
    {
      ...
      "url": "http://arxiv.org/abs/2509.17482",
      "pdf_url": "http://arxiv.org/pdf/2509.17482",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "模型编辑旨在高效修改预训练语言模型中的事实知识，对维持模型的准确性与相关性至关重要。现有编辑方法常引入意外副作用，导致模型性能发生不可预测的下降。现有研究多聚焦改进编辑算法，目标知识的内在属性这一关键影响因素仍未得到充分探索。本文提出知识谱框架对知识分类，发现知识特征可预测编辑效果，进而提出自适应知识诊断框架，提升难编辑成功率并优化计算资源。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有模型编辑研究多忽略目标知识内在属性的影响，现有方法易产生不可预测的副作用。",
      "method": "提出知识谱框架对知识分类，构建知识诊断框架，按知识编辑难度自适应调整编辑强度。",
      "contribution": "揭示知识内在特征可有效预测编辑效果，提出的方法提升难编辑成功率并节约计算资源。",
      "limitations": "摘要未提及",
      "key_finding": "知识的真实世界流行度、模型预编辑熟悉度、提问语言结构是编辑成功与稳定性的强预测因子。",
      "theme": "模型编辑诊断",
      "method_family": "framework/tooling",
      "edit_target": "事实知识",
      "evaluation_signal": "关注模型编辑的成功率、编辑稳定性，同时考量方法对计算资源的优化与副作用控制。",
      "failure_mode": "现有模型编辑方法引入意外副作用，造成模型性能发生不可预测的退化。",
      "idea_hook": "基于知识难度自适应调整编辑强度的思路，可拓展到大规模批量知识编辑场景提升效率。",
      "read_priority": "high",
      "direction_fit": "本文聚焦知识编辑的核心问题分析与方法优化，属于本方向的核心研究内容。",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "title_zh": "FPEdit：基于局部参数编辑的鲁棒大语言模型指纹技术",
      "authors": [
        "Shida Wang",
        "Chaohu Liu",
        "Yubo Wang",
      ...
      "url": "http://arxiv.org/abs/2508.02092",
      "pdf_url": "http://arxiv.org/pdf/2508.02092",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "大语言模型作为高价值智力资产，易遭未授权分发与商用滥用。现有指纹方法存在固有缺陷：内在方法需全参数访问，后门方法的异常触发易被对手检测。本文提出FPEdit框架，利用知识编辑通过稀疏靶向权重修改注入语义连贯的自然语言指纹，提出促-抑值向量优化方法，在保障鲁棒性的同时不降低模型性能。实验表明该方法指纹保留率达95%-100%，对多种变换鲁棒，资源开销低。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有大语言模型指纹方法存在缺陷，要么需全参数访问，要么触发异常易被攻击者检测",
      "method": "利用知识编辑通过稀疏靶向参数修改注入语义连贯指纹，提出促-抑值向量优化方法",
      "contribution": "提出首个同时兼顾适配鲁棒性、抗检测性、模型效用的大语言模型指纹方案，资源开销大幅降低",
      "limitations": "摘要未提及",
      "key_finding": "FPEdit在全参数微调和参数高效适配下指纹保留率达95%-100%，嵌入10组指纹到LLaMA2-7B耗时不足2分钟，显存低于30GB",
      "theme": "大模型指纹",
      "method_family": "framework/tooling",
      "edit_target": "模型参数",
      "evaluation_signal": "评测了指纹在微调、适配、量化、剪枝等场景下的保留率，同时验证了模型下游性能与资源开销",
      "failure_mode": "现有大语言模型指纹方案无法同时兼顾鲁棒性、抗检测性与模型效用",
      "idea_hook": "可拓展基于知识编辑的大模型版权保护研究，探索多场景下大模型指纹的鲁棒性与可扩展性",
      "read_priority": "high",
      "direction_fit": "本文将知识编辑用于大模型指纹溯源，属于知识编辑的落地应用研究，贴合当前研究方向",
      "baselines": [
        "现有内在指纹方法",
        "基于后门的指纹方法"
      ],
    ...
    },
    {
      ...
      "week": "2026-W23",
      "title": "Latent Knowledge Scalpel: Precise and Massive Knowledge Editing for Large Language Models",
      "title_zh": "潜知识手术刀：大语言模型的精准大规模知识编辑",
      "authors": [
        "Xin Liu",
        "Qiyang Song",
        "Shaowen Xu",
      ...
      "url": "http://arxiv.org/abs/2508.03741",
      "pdf_url": "http://arxiv.org/pdf/2508.03741",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "大语言模型预训练常留存不准确或过时信息，导致推理输出错误或偏倚。现有模型编辑方法难以同时处理大量事实编辑，还可能损害模型通用能力。本文经实证发现，可类似编辑自然语言输入般替换实体，编辑大语言模型内部表征，据此提出潜知识手术刀LKS，通过轻量超网络操纵特定实体潜知识，实现精准大规模编辑。在Llama-2和Mistral上实验显示，同时编辑量达1万时，LKS仍能有效编辑知识并保留模型通用能力，代码已开源。",
      "has_code": true,
      "repo_url": "https://github.com/Linuxin-xxx/LKS.",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有大语言模型知识编辑无法同时处理大量事实编辑，且易损害模型原有通用能力。",
      "method": "提出潜知识手术刀LKS，通过轻量超网络操纵特定实体潜知识实现精准大规模知识编辑。",
      "contribution": "提出可实现大规模精准知识编辑的LKS，万级同时编辑仍有效且保留模型通用能力。",
      "limitations": "摘要未提及",
      "key_finding": "当同时编辑数量达到10000次时，LKS仍可有效完成知识编辑且保留模型原有通用能力。",
      "theme": "知识编辑",
      "method_family": "locate-then-edit",
      "edit_target": "事实关联",
      "evaluation_signal": "在Llama-2和Mistral上验证万级同时编辑场景下的编辑有效性与模型通用能力保留效果。",
      "failure_mode": "大规模批量编辑效果差，编辑后模型通用能力出现下降",
      "idea_hook": "可基于该思路探索百万级更大规模知识编辑的优化方案，验证其在更多大模型上的泛化性。",
      "read_priority": "high",
      "direction_fit": "属于大语言模型知识编辑核心方向，针对现有痛点提出新方案，参考价值较高。",
      "baselines": [],
      "datasets": []
    },
    {
      "id": "https://www.semanticscholar.org/paper/ad16b50033ec278983b6287b118351758a5ece9f",
      "direction_id": "editing-frameworks-tooling",
      "direction_name": "编辑框架、工具与基准",
      "week": "2026-W23",
      "title": "Large Language Models in Medical Image Analysis: A Systematic Survey and Future Directions",
      "title_zh": "大语言模型用于医学影像分析：系统综述与未来方向",
      "authors": [
        "Nan Zhang",
        "R. Bayford",
        "Sikandar Ali",
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "当前缺少对大语言模型在医学影像分析领域应用的系统梳理，缺乏清晰的结构化研究指引。",
      "method": "系统梳理领域已有应用，提出涵盖零、一、多三阶段的X阶段大语言模型微调分析框架。",
      "contribution": "系统梳理该领域全部应用，提出X阶段微调分类框架，为领域研究者提供结构化研究指引。",
      "limitations": "现有研究存在数据稀疏、输出幻觉、隐私风险，尚未满足动态知识更新的需求。",
      "key_finding": "提出X阶段微调框架，将大语言模型微调分为零、一、多三个阶段，分别对应不同任务复杂度与可用数据。",
      "theme": "医学影像大模型",
      "method_family": "survey",
      "edit_target": "未知",
      "evaluation_signal": "本文为综述研究，未开展具体实验评测，仅对领域现有研究进行梳理总结。",
      "failure_mode": "现有应用存在输出幻觉、数据稀疏、隐私安全问题，无法满足动态知识更新需求。",
      "idea_hook": "医学影像大模型存在幻觉与动态知识更新需求，可探索面向该场景的可靠知识编辑方案。",
      "read_priority": "medium",
      "direction_fit": "本文提出医学大模型的知识更新与幻觉问题，对知识编辑方向研究有参考价值。",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "title_zh": "角色扮演代理会言行一致吗？基于大语言模型的人类信任模拟中的信念-行为一致性",
      "authors": [
        "Amogh Mannekote",
        "Adam Davies",
        "Guohao Li",
      ...
      "url": "http://arxiv.org/abs/2507.02197",
      "pdf_url": "http://arxiv.org/pdf/2507.02197",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "随着大语言模型（LLM）越来越多地作为角色扮演代理生成人类行为研究合成数据，其输出与分配角色的一致性成为关键问题。本文构建评估框架测量提示引出的信念对模拟结果的预测能力，结合扩充版GenAgents人格库与信任博弈，引入一致性指标分析三类影响因素，探讨了植入研究者理论先验的可行性。研究发现个体和群体层面都存在系统的信念-行为不一致，即使模型有合理信念也未必能一致应用，凸显了明确对齐条件的必要性。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "基于大语言模型的角色扮演行为模拟中，代理陈述信念与实际行为的一致性缺乏系统严谨评估。",
      "method": "构建信念预测模拟结果的评估框架，结合扩充GenAgents人格库与信任博弈，引入一致性指标分析影响因素。",
      "contribution": "构建了LLM角色扮演信念-行为一致性评估框架，揭示了系统存在的信念行为不一致现象。",
      "limitations": "摘要未提及",
      "key_finding": "个体和群体层面都存在系统的LLM陈述/植入信念与模拟行为的不一致，即使编码了合理信念也无法一致应用。",
      "theme": "信念行为一致性",
      "method_family": "evaluation/benchmark",
      "edit_target": "角色扮演代理信念",
      "evaluation_signal": "评测不同条件下LLM角色扮演代理引出的信念与实际模拟行为的一致性，分析多因素对一致性的影响。",
      "failure_mode": "大语言模型角色扮演代理存在陈述信念与实际模拟行为不一致",
      "idea_hook": "可探索提升大语言模型角色扮演代理信念行为一致性的方法，优化LLM行为模拟的可靠性。",
      "read_priority": "medium",
      "direction_fit": "该论文研究LLM代理的信念行为一致性，属于大语言模型可靠性研究范畴，符合方向要求。",
      "baselines": [],
      "datasets": [
        "扩充版GenAgents人格库"
      ]
    },
    {
      ...
      "week": "2026-W23",
      "title": "A Survey of LLM-Driven AI Agent Communication: Protocols, Security Risks, and Defense Countermeasures",
      "title_zh": "大语言模型驱动的AI智能体通信综述：协议、安全风险与防御对策",
      "authors": [
        "Dezhang Kong",
        "Shi Lin",
        "Zhenhua Xu",
      ...
      "url": "http://arxiv.org/abs/2506.19676",
      "pdf_url": "http://arxiv.org/pdf/2506.19676",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "近年来，大语言模型驱动的AI智能体不再孤立运行，开始与其他智能体、工具等外部实体通信以完成复杂任务。智能体通信已成新兴方向，各大机构纷纷推出相关通信协议，但该领域存在显著安全隐患。本文针对智能体通信安全开展全面综述，首次明确定义智能体通信，提出分类框架与三层通信架构，梳理协议、分析各层安全风险，给出防御对策展望，基于MCP与A2A开展实验，探讨开放问题与未来方向，并公开了相关论文汇总仓库。",
      "has_code": true,
      "repo_url": "https://github.com/theshi-1128/awesome-agent-communication-security.",
      "repo_stars": 26,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "新兴大语言模型驱动智能体通信领域缺乏系统梳理，其安全风险尚未得到全面总结分析",
      "method": "构建智能体通信分类框架与三层通信架构，梳理现有协议，结合主流协议实验分析安全隐患",
      "contribution": "首次明确定义智能体通信，系统梳理领域内容，给出风险分析与防御展望，公开相关论文仓库",
      "limitations": "摘要未提及",
      "key_finding": "基于Anthropic MCP与Google A2A的实验验证了智能体通信不同层会产生新型特有安全漏洞",
      "theme": "智能体通信安全",
      "method_family": "survey",
      "edit_target": "不涉及知识编辑",
      "evaluation_signal": "基于主流智能体通信协议MCP、A2A开展验证实验，公开了该领域研究论文的汇总仓库",
      "failure_mode": "摘要未提及",
      "idea_hook": "可探索面向大模型智能体通信场景的安全知识编辑方法，消除通信过程引入的恶意安全风险",
      "read_priority": "medium",
      "direction_fit": "属于大模型智能体安全可靠性领域综述，对安全相关知识编辑选题有参考价值",
      "baselines": [
        "MCP",
        "A2A"
      ],
    ...
    },
    {
      ...
      "title_zh": "DualEdit：面向视觉语言模型知识更新的双模态编辑",
      "authors": [
        "Zhiyi Shi",
        "Binjie Wang",
        "Chongjie Si",
      ...
      "url": "http://arxiv.org/abs/2506.13638",
      "pdf_url": "http://arxiv.org/pdf/2506.13638",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "模型编辑旨在无需耗时全量重训即可高效更新预训练模型知识，现有方法多聚焦单模态大语言模型，视觉语言模型（VLM）中各模态对编辑性能的影响尚不明晰。本文探究文本、视觉模态对模型编辑的影响，发现两类表示在不同层达到峰值敏感度，同时编辑虽可高效更新知识但会损害模型原有能力，据此提出DualEdit编辑器，在两类模态的关键层分别编辑，在更敏感的文本模态引入门控模块，兼顾知识更新与原有能力保留，实验验证其性能优于现有基线，代码已开源。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有模型编辑多聚焦单模态大语言模型，VLM各模态对编辑性能的影响尚未得到充分探索。",
      "method": "提出DualEdit编辑器，在文本和视觉模态各自的关键层编辑，在敏感文本模态引入门控平衡能力。",
      "contribution": "发现VLM编辑中两类模态的敏感度层差异，所提方法性能优于现有SOTA VLM与适配LLM编辑方法。",
      "limitations": "摘要未提及",
      "key_finding": "文本表示与视觉表示在网络不同层达到编辑敏感度峰值，同时编辑双模态会牺牲模型原有能力。",
      "theme": "双模态知识编辑",
      "method_family": "locate-then-edit",
      "edit_target": "事实知识关联",
      "evaluation_signal": "在多个VLM骨干和基准数据集上评测，验证该方法在知识更新和能力保留上优于各类基线方法。",
      "failure_mode": "同时编辑双模态会导致模型原有能力下降",
      "idea_hook": "可探索多模态大模型顺序编辑场景下，不同模态编辑的串扰问题，优化编辑与保留能力的平衡。",
      "read_priority": "high",
      "direction_fit": "属于知识编辑方向，聚焦VLM知识更新问题，方法有新意且开源，符合当前研究方向。",
      "baselines": [
        "现有SOTA VLM编辑基线",
        "适配后的LLM编辑方法"
      ],
    ...
    },
    {
      ...
      "title_zh": "PropMEND：大语言模型中知识传播的超网络方法",
      "authors": [
        "Z. Liu",
        "Greg Durrett",
        "Eunsol Choi"
      ...
      "pdf_url": "http://arxiv.org/pdf/2506.08920",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "现有大语言模型知识编辑技术可注入能逐字复现的知识，但无法实现知识传播，模型不能回答需要利用注入知识推理的问题。本文提出基于超网络的知识传播方法PropMEND，通过元学习修改语言建模损失的梯度，扩展了MEND的元目标，支持回答涉及注入知识的多跳问题。该方法在RippleEdit数据集上，对注入事实未明确给出答案的挑战性多跳问题准确率提升近一倍，作者还引入了新数据集Controlled RippleEdit评估超网络泛化性。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有大语言模型知识编辑仅能注入可复现的知识，无法实现知识传播，难以支持多跳推理问答。",
      "method": "提出基于超网络的PropMEND方法，扩展MEND元目标，通过元学习修改梯度促进注入知识传播。",
      "contribution": "提出PropMEND知识编辑方法，构建新评估数据集Controlled RippleEdit，性能优于现有同类方法。",
      "limitations": "模型在训练未见过的实体-关系对上的知识传播性能仍存在明显的提升空间。",
      "key_finding": "在RippleEdit数据集上，对于答案未显式出现在注入事实中的多跳问题，PropMEND准确率提升近一倍。",
      "theme": "大模型知识编辑",
      "method_family": "meta-learning editor",
      "edit_target": "事实关联知识",
      "evaluation_signal": "评测方法在答案未显式给出的多跳问题上的知识传播能力，以及对未见实体-关系对的泛化性能。",
      "failure_mode": "现有知识编辑注入知识后无法实现知识传播，无法支持需要推理的多跳问答。",
      "idea_hook": "可探索如何进一步提升知识编辑在训练未见的实体-关系对上的知识传播泛化能力。",
      "read_priority": "high",
      "direction_fit": "属于知识编辑核心方向研究，解决领域痛点，提出新方法新基准，参考价值高。",
      "baselines": [
        "现有知识编辑方法"
      ],
      "datasets": [
    ...
    },
    {
      ...
      "title_zh": "MEMOIR：面向大语言模型的最小覆盖与信息感知保留的终身模型编辑",
      "authors": [
        "Ke Wang",
        "Yiming Qin",
      ...
      "url": "http://arxiv.org/abs/2506.07899",
      "pdf_url": "http://arxiv.org/pdf/2506.07899",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "部署在真实系统中的大语言模型常需事后更新以融入或修正知识，但高效可靠编辑且不遗忘旧知识仍是难题。现有终身模型编辑存在泛化不足、干扰旧编辑、无法适配长编辑序列等问题，本文提出可扩展框架MEMOIR，通过残差记忆模块注入知识，用样本依赖掩码限制编辑干扰，在多个基准上取得SOTA性能，可支持数千次顺序编辑且遗忘极小。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有终身大语言模型编辑泛化能力差，会干扰已有编辑，无法扩展到长编辑序列",
      "method": "提出MEMOIR框架，通过独立残差记忆模块注入知识，用样本依赖掩码减少编辑间干扰",
      "contribution": "提出新框架MEMOIR，在多个基准取得SOTA，可支持数千次顺序编辑且遗忘极小",
      "limitations": "摘要未提及",
      "key_finding": "通过样本依赖掩码分隔各编辑占用的不同记忆参数，可支持数千次顺序编辑且遗忘极小，性能达SOTA",
      "theme": "终身模型编辑",
      "method_family": "memory-based editor",
      "edit_target": "事实关联",
      "evaluation_signal": "在LLaMA-3、Mistral backbone上，从可靠性、泛化性、局部性等维度验证方法性能与可扩展性",
      "failure_mode": "编辑间串扰、顺序编辑遗忘旧知识，无法扩展到长编辑序列",
      "idea_hook": "基于稀疏掩码分隔编辑参数的思路，可探索适配更长编辑序列、更大规模大模型的编辑方案",
      "read_priority": "high",
      "direction_fit": "属于大语言模型知识编辑方向，聚焦终身编辑场景，方法新颖具备较高参考价值",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "url": "http://arxiv.org/abs/2506.06800",
      "pdf_url": "http://arxiv.org/pdf/2506.06800",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "现有研究已展现大语言模型（LLMs）在指令遵循与修辞流畅性方面的能力，但尚未系统探索其在心理修辞语境下自主说服与抵抗说服的双重能力。本文先评估四款常用LLM的说服表现，发现原生LLM说服多采用重复策略，成功率较低；引入11种心理说服策略后，发现明确指示使用特定策略可提升成功率，但无通用策略，表现依赖上下文。据此提出基于直接偏好优化的自适应框架，实验证明该方法可提升说服成功率同时保留通用能力，代码已开源。",
      "has_code": true,
      "repo_url": "https://github.com/KalinaEine/PsychologicalPersuasion.",
      "repo_stars": 6,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "现有研究尚未系统探索大语言模型在心理修辞语境下的自主说服与抵抗说服的双重能力",
      "method": "提出基于直接偏好优化的自适应框架，训练大语言模型根据语境自主选择最优心理说服策略",
      "contribution": "提出自适应心理说服框架，实验证明其可有效提升说服成功率，同时保留大语言模型通用能力",
      "limitations": "摘要未提及",
      "key_finding": "原生大语言模型说服多采用重复策略，明确使用特定心理策略可提升成功率，但不存在普适全场景的有效策略",
      "theme": "大模型心理说服",
      "method_family": "framework/tooling",
      "edit_target": "说服行为",
      "evaluation_signal": "在三款开源大语言模型上验证，方法可提升说服成功率同时保留通用能力，相关研究代码已开源",
      "failure_mode": "原生大语言模型自主说服策略单一，成功率低，无法适配不同语境选择最优策略",
      "idea_hook": "可将这种基于偏好优化的自适应策略选择思路，迁移到知识编辑的场景依赖策略优化研究中",
      "read_priority": "medium",
      "direction_fit": "本文的自适应优化思路可迁移至知识编辑领域的场景适配策略研究中",
      "baselines": [
        "原生大语言模型",
        "固定策略指示大语言模型"
      ],
    ...
    },
    {
      ...
      "title_zh": "InComeS：集成压缩与选择机制到大语言模型实现高效模型编辑",
      "authors": [
        "Shuaiyi Li",
        "Zhisong Zhang",
        "Yang Deng",
      ...
      "url": "http://arxiv.org/abs/2505.22156",
      "pdf_url": "http://arxiv.org/pdf/2505.22156",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "现有模型编辑方法虽能较好召回编辑事实，但在需要深度语义理解而非简单知识复述的复杂场景表现欠佳；基于上下文学习的大语言模型编辑方法依托推理能力颇具前景，但受限于LLM有限上下文窗口，随编辑量增加性能与效率下降。本文提出InComeS框架，通过显式压缩与选择机制提升LLM处理编辑上下文的能力，在多个基准实验验证了其有效性与效率。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "基于上下文学习的大语言模型编辑受限于上下文窗口，编辑量增加会导致性能与效率下降",
      "method": "将每个编辑上下文压缩到特殊gist token的KV缓存，新增交叉注意力动态选择相关编辑信息",
      "contribution": "提出InComeS灵活编辑框架，突破上下文窗口限制，在多个基准验证了方法的有效性与效率",
      "limitations": "摘要未提及",
      "key_finding": "将编辑上下文压缩到特殊gist token的KV缓存搭配动态选择，可突破LLM上下文窗口限制处理多编辑任务",
      "theme": "高效模型编辑",
      "method_family": "memory-based editor",
      "edit_target": "事实关联",
      "evaluation_signal": "在涵盖多种编辑格式的多样模型编辑基准上开展实验，验证方法的编辑有效性与处理效率",
      "failure_mode": "基于上下文学习的编辑随编辑量增加，发生性能退化、效率降低",
      "idea_hook": "可探索结合更高效的压缩方法，进一步提升该框架在大规模多编辑场景下的性能",
      "read_priority": "high",
      "direction_fit": "属于知识编辑核心研究方向，针对现有方法痛点提出创新方案，相关性强",
      "baselines": [],
      "datasets": []
    },
    {
      ...
      "url": "http://arxiv.org/abs/2505.20819",
      "pdf_url": "http://arxiv.org/pdf/2505.20819",
      "category": "via-citation",
      "published": "",
      "collected": "2026-06-02",
      ...
      "abstract_zh": "知识编辑方法是更新大语言模型事实内容的低成本方案，但存在双重用途风险：其既可以更新错误过时信息，也可被恶意利用植入错误信息或偏见。为防御这类恶意操纵，本文提出追踪与逆转编辑的任务，仅基于修改后的权重即可推断编辑对象，准确率达99%；还提出无训练的编辑逆转方法，无需编辑相关信息即可逆转94%的编辑，还可区分编辑与未编辑权重，验证了该方向可行性。",
      "has_code": false,
      "repo_url": "",
      "repo_stars": 0,
      "hf_upvotes": 0,
      ...
      "venue_confidence": "",
      "venue_source": "",
      "problem": "知识编辑可被恶意利用植入错误信息或偏见，现有缺乏可靠防御恶意编辑的技术",
      "method": "提出编辑追踪与逆转任务，仅基于修改权重推断编辑对象，设计无训练的无额外信息编辑逆转方法",
      "contribution": "提出编辑追踪逆转新任务，验证仅靠编辑权重实现目标的可行性，开辟大模型防护新方向",
      "limitations": "摘要未提及",
      "key_finding": "仅基于修改后的模型权重推断编辑对象准确率可达99%，无需编辑信息即可逆转94%的编辑",
      "theme": "大模型编辑安全",
      "method_family": "unlearning",
      "edit_target": "恶意编辑事实关联",
      "evaluation_signal": "仅基于修改权重追踪编辑对象准确率达99%，无需编辑相关信息可逆转94%编辑，恢复原输出分布",
      "failure_mode": "知识编辑可被恶意利用，植入错误信息与偏见操纵大模型",
      "idea_hook": "可拓展研究多轮连续恶意编辑的追踪与逆转，提升复杂场景下大模型防恶意编辑的能力",
      "read_priority": "high",
      "direction_fit": "本文研究恶意知识编辑的防御问题，属于知识编辑与大模型可靠性领域，契合研究方向",
      "baselines": [],
      "datasets": []
    }
  ]
