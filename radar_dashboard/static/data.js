...
window.RADAR_STATIC_DATA = {
  "generated_at": "2026-05-31 22:43:15",
  "summary": {
    ...
    "failure_mode_groups": [
      {
        "label": "顺序编辑退化",
        "count": 24,
        "example": "跨模态冲突、顺序编辑的长周期干扰与编辑间串扰"
      },
      {
        "label": "冲突与串扰",
        "count": 17,
        "example": "因果错位导致编辑局限于单样本，特征纠缠引发无关知识意外改动"
      },
      {
        "label": "通用能力下降",
        "count": 16,
        "example": "现有遗忘方法计算成本高，遗忘后易损害模型相关知识与整体效用"
      },
      {
        "label": "多模态 / 跨语言迁移失败",
        "count": 12,
        "example": "现有多模态知识编辑无法在语义等价的多模态变体间有效传播编辑效果"
      },
      {
        "label": "遗忘不彻底 / 可恢复",
        "count": 11,
        "example": "概念擦除过程中误扭曲无关非目标概念的编辑串扰问题"
      },
      {
        "label": "局部性不足 / 副作用",
        "count": 10,
        "example": "干预后意外副作用难以自动发现，容易产生虚假差异结论"
      }
    ],
    "evaluation_signal_groups": [
      {
        "label": "基准 / 代码资源",
        "count": 43,
        "example": "在多个基准和多款多模态大语言模型上评测，验证方法兼顾编辑局部性与向相关上下文的泛化能力。"
      },
      {
        "label": "遗忘-保留权衡",
        "count": 35,
        "example": "评测知识注入准确率与原有能力保留程度，重点考察知识记忆与能力保留的权衡效果。"
      },
      {
        "label": "泛化 / 鲁棒性",
        "count": 22,
      ...
      },
      {
        "label": "编辑有效性",
        "count": 18,
        "example": "在Minerva Math基准的7个数学科目评测，该方法显著提升5个科目准确率，无显著性能退化"
      },
      {
        "label": "效率 / 规模",
        "count": 18,
        "example": "在多个多模态大语言模型骨干和在线编辑基准上，评测了方法的可靠性、泛化性、局部性与效率。"
      },
      {
        "label": "局部性 / 副作用",
        "count": 17,
